...
const UpdateCustomerDetails = ({ onCustomerSelect, initialCustomer }) => {
  ...
  useEffect(() => {
    if (initialCustomer) {
      ...
      setSelectedBillingAddress(initialCustomer.selectedBillingAddress);
      setSelectedShippingAddress(initialCustomer.selectedShippingAddress);
    }
  }, [initialCustomer]);
  ...
  return (
    <div className="p-6 bg-white rounded-lg shadow-md">
      <div className="mb-6">
        <h1 className="text-sm font-semibold mb-2">Customer Information</h1>
      ...
      {selectedCustomer && (
        <div className="space-y-6">
          <div>
            ...
            {selectedBillingAddress && (
              <div className="p-4 bg-gray-50 rounded relative text-xs">
                <p>
                  {selectedBillingAddress.address || "N/A"},{" "}
                  {selectedBillingAddress.city || "N/A"}
                </p>
                <p>
                  {selectedBillingAddress.state || "N/A"},{" "}
                  {selectedBillingAddress.pincode || "N/A"}
                </p>
                <CloseOutlined
                  className="absolute text-xs top-2 right-2 text-gray-500 hover:text-red-500 cursor-pointer"
          ...
          <div>
            ...
            {selectedShippingAddress && (
              <div className="p-4 bg-gray-50 rounded relative text-xs">
                <p>
                  {selectedShippingAddress.address || "N/A"},{" "}
                  {selectedShippingAddress.city || "N/A"}
                </p>
                <p>
                  {selectedShippingAddress.state || "N/A"},{" "}
                  {selectedShippingAddress.pincode || "N/A"}
                </p>
                <CloseOutlined
                  className="absolute text-xs top-2 right-2 text-gray-500 hover:text-red-500 cursor-pointer"
